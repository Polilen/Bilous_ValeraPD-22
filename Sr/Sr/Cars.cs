...
namespace sr
{
    class Cars
    {
        ...
        public Cars()
        {
            string[] colors_1 = { "Purple", "White" };
            string[] colors_2 = { "Yellow", "Black" };
            string[] colors_3 = { "Black", "Yellow" };
            cars.Add(new Car(colors_1, 1999, 940000, 200));
            cars.Add(new Car(colors_2, 1997, 55000, 150));
            cars.Add(new Car(colors_1, 2000, 115000, 160));
            cars.Add(new Car(colors_2, 2005, 675000, 170));
            cars.Add(new Car(colors_3, 2001, 110000, 155));
        }
        ...
        public void findCar(byte amount, string color, int yearOfMade = 0, int price = 0, int enginePower = 0)
        {
            ...
            {
                Console.WriteLine("\nИзвините, пока машин с такими параметрами нет на складе ):");
            }
        }
